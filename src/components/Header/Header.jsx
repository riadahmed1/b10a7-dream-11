...
const Header = ({handleAddCoins}) => {
  return (
    <div className="bg-black bg-[url(/src/assets/bg-shadow.png)] w-full bg-cover bg-center bg-no-repeat py-5 flex flex-col gap-5 rounded-3xl mb-10">
      <img src="/src/assets/banner-main.png" alt="" className='mx-auto'/>
